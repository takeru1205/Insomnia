...
class ReplayBuffer:
    def __init__(self, max_size, input_shape, n_actions):
        ...
        self.mem_cntr = 0
        self.state_memory = torch.zeros((self.mem_size, *input_shape), dtype=torch.uint8)
        self.new_state_memory = torch.zeros((self.mem_size, *input_shape), dtype=torch.uint8)
        self.action_memory = torch.zeros((self.mem_size, n_actions), dtype=torch.float)
